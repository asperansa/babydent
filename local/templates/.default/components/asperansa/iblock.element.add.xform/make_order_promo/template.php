...
<form id="make_order" name="iblock_add" action="<?=POST_FORM_ACTION_URI?>" method="post" enctype="multipart/form-data">
    ...
    <div class="bl_form_header">Запись на приём</div>
	<?if (is_array($arResult["PROPERTY_LIST"]) && !empty($arResult["PROPERTY_LIST"])):?>
		<div class="bl_form_row_pole">
			<? ShowFormHeaderField1("NAME", $arResult, $arParams); ?>
		</div>
		<div class="bl_form_row_pole">
			<? ShowFormHeaderField1("1", $arResult, $arParams); ?>
		</div>
		<div class="bl_form_row_pole">
			<? ShowFormHeaderField1("PREVIEW_TEXT", $arResult, $arParams); ?>
		</div>	
