...
$isReviews = "N";
$resReviews = CIBlockElement::GetList(Array("SORT"=>"ASC"), Array("PROPERTY_DOCTOR" => $ElementID, "IBLOCK_ID"=>9, "ACTIVE"=>"Y"), false, false, array('NAME'));
while($arReviews = $resReviews->GetNext()) {
	$isReviews = 'Y';
}
if ($isReviews == 'Y'):?>
<section id="reviews" class="bottom_common_reviews">
	<h2>Отзывы о специалисте</h2>
	<? $GLOBALS['arrFilter'] = array('PROPERTY_DOCTOR' => $ElementID);
