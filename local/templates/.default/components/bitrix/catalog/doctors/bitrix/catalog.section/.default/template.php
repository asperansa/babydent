...
foreach ($arResult['ITEMS'] as $key => $arItem)
{
	...
	?><div class="bl_result_filter_item" id="<? echo $strMainID; ?>">
		<!--<span id="<? echo $arItemIDs['PICT']; ?>"
			href="<? echo $arItem['DETAIL_PAGE_URL']; ?>"
			class="img"

			title="<? echo $strTitle; ?>">
            <img alt="<? echo $strTitle; ?>" src="<? echo $arItem['PREVIEW_PICTURE']['SRC']; ?>" />
            <span class="ico"></span>-->
    <?
	...
	?>
	<section <?=($key % 2 == 0)? "" : 'class="section_doc_photo_right"'?>>
		<div class="main_bl_personal common_carousel">
			<div class="main_bl_personal_carousel">
				<div class="main_bl_personal_carousel_item">
...
<?
	...
	<?Helper::IncludeFile('doctor_not_found');?>
	</article>
	<?
}