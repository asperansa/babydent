...
foreach($arResult['ITEMS'] as &$arItem) {
    if (!empty($arItem['DISPLAY_PROPERTIES']['HOUSE']['VALUE'])) {
    $rsProperty = CIBlockElement::GetProperty(6, $arItem['DISPLAY_PROPERTIES']['HOUSE']['VALUE'], array('sort' => 'asc'), array('CODE' => 'FIRSTAREA'));
    if($arProperty = $rsProperty->Fetch()) {
        
        $arItem['DISPLAY_PROPERTIES']['INFO']['FIRSTAREA'] = $arProperty['VALUE'];
    }
    unset($arProperty);
    $rsProperty = CIBlockElement::GetProperty(6, $arItem['DISPLAY_PROPERTIES']['HOUSE']['VALUE'], array('sort' => 'asc'), array('CODE' => 'SECONDAREA'));
    if($arProperty = $rsProperty->Fetch()) {
        $arItem['DISPLAY_PROPERTIES']['INFO']['SECONDAREA'] = $arProperty['VALUE'];
    }
	unset($arProperty);
    $rsProperty = CIBlockElement::GetProperty(6, $arItem['DISPLAY_PROPERTIES']['HOUSE']['VALUE'], array('sort' => 'asc'), array('CODE' => 'COST'));
    if($arProperty = $rsProperty->Fetch()) {
        $arItem['DISPLAY_PROPERTIES']['INFO']['COST'] = $arProperty['VALUE'];
    }
	unset($arProperty);
    $rsProperty = CIBlockElement::GetProperty(6, $arItem['DISPLAY_PROPERTIES']['HOUSE']['VALUE'], array('sort' => 'asc'), array('CODE' => 'PHOTOS'));
    if($arProperty = $rsProperty->Fetch()) {
	    //$arItem['DISPLAY_PROPERTIES']['INFO']['PHOTOS'] = $arProperty['VALUE'];
		$arFilter = '';
	...
	//print_r($arItem['DISPLAY_PROPERTIES']['INFO']['PHOTOS']);
