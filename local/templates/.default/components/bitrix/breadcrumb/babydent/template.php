...
$strReturn = '<div class="inner_page_header_link">';//<b class="r0 top"></b><p><a href="'.SITE_DIR.'" title="'.GetMessage("HDR_GOTO_MAIN").'"><img src="'.SITE_TEMPLATE_PATH.'/images/home.gif" width="9" height="8" /></a>';
...
$strReturn .= '</div>';//'</p><b class="r0 bottom"></b>';
return $strReturn;
?>
